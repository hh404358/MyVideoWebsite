	...
	<div >
						...
						<el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal"
							...
							<el-submenu index="/Share">
								...
								<el-menu-item v-for="(item, index) in classListObj" :key="'class1' + index"
									:index="'/Share?classId=' + (index+1)">{{ item }}</el-menu-item>
							</el-submenu>
		...
		<div class="headImgBox"
			...
			<div class="h-information">
				...
				<img :src="this.$store.state.themeObj.head_portrait ? this.$store.state.themeObj.head_portrait : 'static/img/tou1.jpg'"
					alt="">

				<h2 class="h-description">

					{{ this.$store.state.themeObj.autograph ? this.$store.state.themeObj.autograph : "日月不问赶路人，时光不负有心人" }}
...
</style>./Home.vue/index.js ./Share.vue/index.js ./DetailVideo.vue/index.js
