...
<template>
    <div class="box">
        ...
        <section class="rs4">
            <h2 class="ui label">粉丝列表</h2>
            <ul>
                <li v-for="(item, index) in fanList" :key="'fanList' + index">
                    <img src=item.avatar />{{item.nickName }}
                  
                </li>
            </ul>
            <h2 class="ui label">关注列表</h2>
            <ul>
                <li v-for="(item, index) in focusList" :key="'fanList' + index">
                    <img src=item.avatar />{{item.nickName }}
                  
                </li>
            </ul>
            <h2 class="ui label">朋友列表</h2>
            <ul>
                <li v-for="(item, index) in friendList" :key="'fanList' + index">
                    <img src=item.avatar />{{item.nickName }}
...
<script>
import { focus, fans, friends } from '../api/social.js'
export default {
    data() {
        //选项 / 数据
        return {
